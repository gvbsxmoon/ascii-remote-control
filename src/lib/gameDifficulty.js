...
const MAX_BUG_LIFETIME = 6_000;
const MIN_BUG_LIFETIME = 4_000;
const MAX_SPAWN_INTERVAL = 3_600;
const MIN_SPAWN_INTERVAL = 1_500;
...
export const LEVEL_PROFILES = Array.from({ length: MAX_LEVEL }, (_, index) => {
  ...
  return Object.freeze({
    ...
    successDelay: roundTo(Math.max(650, spawnInterval * 0.42), 50),
    missRecoveryDelay: roundTo(Math.max(450, spawnInterval * 0.25), 50),
  });
});
